...
case $key in 
     ...
     docker cp mediadocker_db.media_1:/tmp/nf_media_barebone.sql ./nf_media_barebone_$NOW.sql
     ;;
     *)
     ...
     docker cp mediadocker_db.media_1:/tmp/nf_media_mysqldump.sql ./nf_media_full_$NOW.sql
     ;;
esac
